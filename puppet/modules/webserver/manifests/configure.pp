...
class webserver::configure {

$conf_name = $facts['os']['family'] ? {
    'Debian' => 'php-memcached-debian.ini',
    'RedHat' => 'php-memcached-redhat.ini',
}
...
file { $conf_name:
  ...
  group  => 'root',
  mode   => '0644',
  source => "puppet:///modules/webserver/${conf_name}",
...
file { 'cache-test.php':
  ...
  group  => $perm_user,
  mode   => '0644',
  source => 'puppet:///modules/webserver/cache-test.php'
}
file { 'index.html':
  ensure => absent,
